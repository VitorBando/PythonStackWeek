...
# obriga o uso do login para a função novo_evento
@login_required
...
def novo_evento(request):
    ...
    # armazena os dados do novo evento para salvar no banco
        evento = Evento(
...
# gerenciamento do evento para filtra evento ou localizar evento
...
def inscrever_evento(request, id):
    ...
    if request.method == "GET":
        ...
        # TODO Validar se o usuario já é um participante
